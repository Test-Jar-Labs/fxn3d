...
namespace Function.Services {
    ...
    public sealed class PredictionService {
        ...
        /// <param name="async">This determines whether or not the prediction is async (Unused).</param>
        ...
        /// <param name="acceleration">Prediction acceleration.</param>
        /// <param name="device">Prediction device. Do not set this unless you know what you are doing.</param>
        /// <param name="async">This determines whether or not the prediction is streamed asynchronously, Unused right now.</param>
